...
void host_action_emits_once_on_press_and_none_on_release() {
  const ai_keyboard::Action action{
      ai_keyboard::ActionKind::HostAction,
      "",
  ...
  assert(press.value == "123e4567-e89b-12d3-a456-426614174000");
...
int main() {
  ...
  host_action_emits_once_on_press_and_none_on_release();
  return 0;
}
